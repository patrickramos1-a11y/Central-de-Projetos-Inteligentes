...
const tableColumns: Record<string, string[]> = {
  ...
  generated_prompts: ["id", "project_id", "summary_id", "summary_item_id", "base_prompt_id", "base_prompt_snapshot", "selected_blocks_json", "final_prompt", "notes", "ai_tool_id", "created_by", "created_at", "status", "archived_at"],
